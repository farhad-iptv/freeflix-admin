    ...
    <div className="flex flex-col h-full">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">Manage M3U playlist categories</p>
        </div>
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
           <div className="bg-white rounded-xl max-w-md w-full shadow-xl overflow-hidden">
             <div className="flex justify-between items-center px-6 py-4 border-b border-slate-100">
                ...
                <button onClick={() => setIsModalOpen(false)} className="text-slate-400 hover:text-slate-600 focus:outline-none"><X className="w-5 h-5"/></button>
             </div>
             <div className="overflow-y-auto max-h-[70vh]">
               <form id="cat-form" onSubmit={handleSaveCategory} className="p-6 space-y-4">
                <div>
                ...
                <div className="pt-4 flex justify-end gap-3 border-t border-slate-100">
                   ...
                   <button type="submit" form="cat-form" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium">Save to List</button>
                </div>
               </form>
             </div>
           </div>
